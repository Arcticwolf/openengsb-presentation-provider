...
public class Signal {
    @OpenEngSBModelId
    private String id;
    @OpenEngSBForeignKey(modelType = Eplan.class, modelVersion = "3.0.0.SNAPSHOT")
    private String eplanId;
    @OpenEngSBForeignKey(modelType = Logicad.class, modelVersion = "3.0.0.SNAPSHOT")
    private String logicId;
    @OpenEngSBForeignKey(modelType = Zuli.class, modelVersion = "3.0.0.SNAPSHOT")
    ...
    public String getZuliId() {
        return zuliId;
    }

    public void setZuliId(String zuliId) {
        this.zuliId = zuliId;
    }
